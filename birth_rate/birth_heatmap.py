...
h1 = mp.font_manager.FontProperties(family='monospace', size='large')
h2 = mp.font_manager.FontProperties(family='monospace', size='small')
h3 = mp.font_manager.FontProperties(family='monospace', size='x-small')
...
# Annotations
ax.text(-0.5, -4.2,
        'USA Birth Rate Every Month 1933-2015',
        fontsize = 14,
        color = 'black',
        weight = 'bold',
        family = 'monospace')
ax.text(-0.5, -2,
        'Birth rate per day per million people, binned by month',
        fontsize = 12,
        color = 'black',
        family = 'monospace')
ax.text(64, -2,
...
# Annotations
ax.text(-0.5, -3.5,
        'USA Birth Rate Every Month ' + str(min_year) + '-' + str(max_year),
        fontsize = 12,
        color = 'black',
        weight = 'bold',
        family = 'monospace')
